  ...
  function translateWords (text) {
    ...
    translate.translateText(translateParams, function (err, data) {
      ...
      if (data) {
        ...
        var card = $("#card");
        var srcLanguage = $("<p>").text("Source Language Code: " + data.SourceLanguageCode);
        var tarLanguage = $("<p>").text("Target Language Code: " + data.TargetLanguageCode);
        card.append(srcLanguage, tarLanguage);
